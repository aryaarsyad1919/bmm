    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Edit artikel & Services</h3>
                                </div>
                                <div class="block-content">

                                    <div class="form-group">
                                            <input type="text" name="xnama" value="<?php echo $b['nama'];?>" class="form-control" placeholder="Nama artikel & Services" required>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify2" data-height="350" data-default-file="<?php echo base_url().'assets/images/'.$b['gambar'];?>">
                                    </div>


                                </div>
                                <div class="block-content block-content-full block-content-md bg-body-light">
                                    <input type="hidden" name="kode" value="<?php echo $b['kd_artikel'];?>" required>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Created with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="muh_aryaarsyad" target="_blank">Muh Arya Arsyad  </a>
                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('.dropify2').dropify({
                    messages: {
                        default: 'Image 1080 X 1080 Pixels',
                        replace: 'Ganti',
                        remove:  'Hapus',
                        error:   'error'
                    }
