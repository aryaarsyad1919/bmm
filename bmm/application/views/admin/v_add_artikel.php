                    ...
                    <div class="row">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    ...
                                    <div class="form-group">
                                            <input type="text" name="xnama" class="form-control" placeholder="Nama artikel & Services" required>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify2" data-height="350" required>
                                    </div>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    ...
                    <div class="float-left">
                        <a class="font-w600" href="https://muharyaarsyad.com" target="_blank">M Arya</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
