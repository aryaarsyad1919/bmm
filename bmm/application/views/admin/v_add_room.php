                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url().'admin/room'?>"><i class="si si-star"></i><span class="sidebar-mini-hide">Galery</span></a>
                                </li>

                                <li>
                                    <a href="<?php echo base_url().'admin/events'?>"><i class="si si-calendar"></i><span class="sidebar-mini-hide">Event</span></a>
                                </li>
                                <li>
                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="form-group">
                                            <input type="text" name="xrate" class="form-control" placeholder="Publish " required>
                                    </div>
                                    <div class="form-group">
