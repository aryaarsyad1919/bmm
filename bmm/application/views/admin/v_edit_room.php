                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="form-group">
                                        <input type="text" name="xrate" value="<?php echo $b['rate'];?>" class="form-control" placeholder="Publish Rate" required>
                                    </div>
                                    <div class="form-group">
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    ...
                    <div class="float-left">
                        <a class="font-w600" href="https://muharyaarsyad.com" target="_blank">M Fikri</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
