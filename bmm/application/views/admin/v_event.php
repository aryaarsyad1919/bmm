                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a href="<?php echo base_url().'admin/artikel'?>"><i class="si si-badge"></i><span class="sidebar-mini-hide">Artikel</span></a>
                                </li>
                                <li>
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">
                                <input type="text" name="xjadwal" class="form-control" placeholder="at. Hari & Waktu" required>
                            </div>
                            <div class="form-group">
                                <input type="date" name="xtanggal" class="form-control" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">
                                <input type="text" name="xjadwal2" class="form-control" placeholder="at (Hari)" required>
                            </div>
                            <div class="form-group">
                                <input type="date" name="xtanggal2" class="form-control" required>
                            </div>
