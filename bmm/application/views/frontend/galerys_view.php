                        ...
                        <div class="col-lg-10 col-lg-offset-1">
                            ...
                            <div class="<?php echo $rata;?>">
                                ...
                                <div class="text-thumbs">
                                    ...
                                    <div class="thumbs">
                                        <a href=" "><img src="<?php echo base_url(). 'assets/images/'. $row->gambar_kotak;?>" alt=""></a>
                                    </div>

                                    <div class="text">
                                      <h2 style="text-align:center;><span class="price"><span class="amout"><b><?php echo $row->rate;?></b></span></span></h2>
                                        <?php echo $row->detail;?>
                                        <!-- <a href=" " class="awe-btn awe-btn-13">BOOK NOW</a> -->
										</div>
